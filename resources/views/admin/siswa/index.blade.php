            ...
            <table>
                ...
                @forelse($siswa as $i => $s)
                    <tr>
                        ...
                        <td class="flex gap-2">
                            <a href="{{ route('admin.siswa.edit', $s) }}" class="btn btn-warning btn-sm"><i class="fas fa-edit"></i></a>
                            ...
                            <form action="{{ route('admin.siswa.destroy', $s) }}" method="POST" onsubmit="return confirm('Hapus?')">@csrf @method('DELETE')<button class="btn btn-danger btn-sm"><i class="fas fa-trash"></i></button></form>
                        </td>
                    </tr>
                @empty
